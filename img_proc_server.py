...
def equalize_img(img):
    ...
    :param img: rgb array of image to be processed
    :type img: int
    :returns equalized: rgb array of equalized image
    :type equalized: int
    """
...
def contr_stretch_img(img):
    ...
    :param img: rgb array of image to be processed
    :type img: int
    :returns stretched: rgb array of stretched image
    :type stretched: int
    """
...
def log_correct_img(img):
    ...
    :param img: rgb array of image to be processed
    :type img: int
    :returns log_img: rgb array of log_corrected image
    :type log_img: int
    """
...
def reverse_img(img):
    ...
    :param img: rgb array of image to be processed
    :type img: int
    :returns reverse_img: rgb array of equalized image
